...
import { favicon } from "./gulp/tasks/copy.js";
...
function watcher(){
    ...
    gulp.watch(path.watch.js, mainJs);
...
const mainTasks = gulp.series(fonts, gulp.parallel(files, jsVendor, json, cssVendor, html, scss, appJs, mainJs, images, favicon));
